...
public class MissionStepTest {
    ...
    void 삼단계() {
        ...
        Long timeId = jdbcTemplate.queryForObject("SELECT id FROM time WHERE time = ?", Long.class, "15:40");
    ...
    void 육단계() {
        ...
        List<ReservationGetResponse> reservations = RestAssured.given().log().all()
                .when().get("reservations")
                .then().log().all()
    ...
    void 칠단계() {
        ...
        Long timeId = jdbcTemplate.queryForObject("SELECT id FROM time WHERE time = ?", Long.class, "10:00");
