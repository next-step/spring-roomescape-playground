...
class RequestReservationTest {
    ...
    void shouldThrowException_whenEmptyReservationNameOfData() {
        // given // when // then
        assertThatThrownBy(() -> new RequestReservation("2025-06-30", "", "12:00"))
    ...
    void shouldThrowException_whenReservationIsPast() {
        ...
        // when // then
        assertThatThrownBy(() -> new RequestReservation(yesterday, "지윤", "10:00").validatePasted())
                .isInstanceOf(InvalidValueException.class)
                .hasMessage("이미 지난 날짜 및 시간은 예약할 수 없어요.");
    }
}
