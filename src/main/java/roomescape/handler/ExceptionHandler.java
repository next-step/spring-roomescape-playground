...
public class ExceptionHandler {
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler({NotFoundReservationException.class, BadRequestException.class, MethodArgumentNotValidException.class})
