...
class ReservationTest {
    private final Clock clock = Clock.fixed(Instant.parse("2030-08-05T15:40:00Z"), ZoneOffset.UTC);

    @Test
    void 현재_시간보다_이전이면_예약할_수_없다() {
        assertThatThrownBy(() -> Reservation.create(
                1L, "브라운", LocalDate.of(2030, 8, 5), LocalTime.of(15, 39), clock))
    ...
    void 현재_시간이면_예약할_수_있다() {
        assertThatCode(() -> Reservation.create(
                1L, "브라운", LocalDate.of(2030, 8, 5), LocalTime.of(15, 40), clock))
