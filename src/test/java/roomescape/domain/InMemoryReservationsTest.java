...
class InMemoryReservationsTest {
    ...
    @Test
    void 예약을_추가한다() {
        Reservation saved = reservations.add(new Reservation("성철", LocalDate.now(), LocalTime.parse("11:11")));
    ...
    void 예약_추가시_id는_1부터_순차_부여된다() {
        Reservation saved = reservations.add(new Reservation("성철", LocalDate.now(), LocalTime.parse("11:11")));
        Reservation other = reservations.add(new Reservation("성철", LocalDate.now(), LocalTime.parse("12:12")));
